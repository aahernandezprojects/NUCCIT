...
function Footer() {
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between h-[75vh] lg:h-[40vh] w-full bg-base-200 px-10 py-10">
      <div className="flex w-full h-fit gap-3 lg:gap-10">
        <div className="flex gap-2 flex-col w-1/2 lg:w-fit h-full">
          <img src={Logo} className="w-1/4 lg:w-7" alt="Logo" />
          <a
      ...
      <div>
        <div className="flex mt-10 lg:mt-3 gap-3">
          <FaTwitter />
          <FaFacebook />
          <FaInstagram />
        </div>
